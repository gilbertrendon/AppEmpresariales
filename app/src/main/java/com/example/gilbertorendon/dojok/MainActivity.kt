package com.example.gilbertorendon.dojok
...
import com.example.gilbertorendon.dojok.database.DBHelper
import com.example.gilbertorendon.dojok.model.Note
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
           val openNewNote = Intent(this, NewNoteActivity::class.java)
